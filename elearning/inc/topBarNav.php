      ...
      <nav class="main-header navbar navbar-expand-md navbar-dark navbar-white bg-purple">
      <div class="container">
        <a href="<?php echo base_url ?>" class="navbar-brand">
          <img src="<?php echo validate_image($_settings->info('logo')) ?>" alt="AdminLTE Logo"
            class="brand-image img-circle elevation-3" style="width: 1.88rem;height: 1.88rem;max-height: unset">
