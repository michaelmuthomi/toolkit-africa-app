...
<div class="card card-outline cardprimary w-fluid">
	...
	<div class="card-body">
            ...
            <div id="lesson_slides" class="carousel slide" data-ride="carousel" data-interval="0">
                <div class="carousel-inner">
                    ...
                    ?>
                                                ...
                                                $active = ""; ?>" data-slide-index="<?php echo $k; ?>">
        ...
        <div class="text-center mt-4 mb-2">
            <a href="lesson/certificate.php?lesson_id=<?= $id ?>" class="btn btn-success" target="_blank">Download Completion Certificate</a>
        </div>
        </div>
    </div>
</div>
...
<script>
    $(function(){
        ...
        $('#get_certificate_btn').click(function () {
            window.open('certificate.php?lesson_id=<?php echo $id; ?>', '_blank');
        });
    })
</script>