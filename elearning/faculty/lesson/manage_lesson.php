		...
		<div class="container-fluid">
			<form action="" id="manage-lesson">
				...
				<!-- <div class="form-group">
					...
					<input type="file" class="form-control" name="ppt_slide[]" multiple="" accept="image/x-png,image/gif,image/jpeg" <?php echo !isset($id) ? "required" : ""; ?> >
				</div> -->
			</form>
		</div>
	</div>
		 	...
		 	$.ajax({
				...
				success:function(resp){
					if(resp>0){
						...
						alert_toast('Lesson Posted successfully.');
					}
					end_loader();
				}
			})
