...
$sql = "SELECT * FROM driver_tasks where status =2 and dispatch ='$driver'"; // Fetch all dispatch tasks
                    ...
                    <tbody>
                      <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        <tr>
                          ...
                          <td><?php echo isset($row['productsname']) ? nl2br($row['productsname']) : ''; ?></td>
                          <td><?php echo isset($row['quantity']) ? nl2br($row['quantity']) : ''; ?></td>
                          <td><?php echo isset($row['driver']) ? $row['driver'] : ''; ?></td>
                          <td>
                            <?php
