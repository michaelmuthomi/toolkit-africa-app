...
if ($cadm_password!= $password) {
    ...
    if(mysqli_num_rows(mysqli_query($conn,"SELECT * from servicemanager where email='$email'"))>0){
        if(mysqli_query($conn,"UPDATE servicemanager set password='$password' where email='$email'")){
