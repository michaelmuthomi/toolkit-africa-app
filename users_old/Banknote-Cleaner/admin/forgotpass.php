...
if ($cadm_password!= $password) {
    ...
    if(mysqli_num_rows(mysqli_query($conn,"SELECT * from bnote_cleaner where email='$email'"))>0){
        if(mysqli_query($conn,"UPDATE bnote_cleaner set password='$password' where email='$email'")){
