                        ...
                        <div class="box-body table-responsive">
                                ...
                                <table id="tasksTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM supervisor_tasks WHERE supervisor = '$supervisor'";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>{$status}</td>";
                                            echo "<td><button class='btn btn-primary' data-toggle='modal' data-target='#confirmModal{$row['No']}' {$buttonDisabled}>Start Work</button></td>";
                                            echo "</tr>";
                                            ...
                                            echo "<h4 class='modal-title' id='confirmModalLabel{$row['No']}'>Confirm Start Work</h4>";
                                            ...
                                            echo "<a href='update_status.php?id={$row['No']}' class='btn btn-primary'>Confirm</a>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</div>";
