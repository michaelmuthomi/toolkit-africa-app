...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "UPDATE supervisor_tasks SET status = 2 WHERE No = $task_id";
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            switch ($row['status']) {
                                                case 0:
                                                    $status = 'Pending';
                                                    $buttonDisabled = 'disabled'; // Button is d
                                                    break;
                                                case 1:
                                                    $status = 'Work Started';
                                            ...
                                            echo "<a href='my-task.php?id={$row['No']}' class='btn btn-primary'>Confirm</a>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</div>";
                                            echo "</div>";
