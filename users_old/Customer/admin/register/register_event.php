...
$sql="INSERT INTO  candidates(stu_id,fullname,email,phone,address,eventname,charges,category,transactioncode) VALUES(:stu_id,:fullname,:email,:phone,:address,:eventname,:charges,:category,:transactioncode)";
