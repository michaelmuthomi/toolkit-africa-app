...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'update') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success'] = 'Product Request updated successfully.';
    } else {
...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          ";
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Post a New Product Request</h3>
                    </div>
                    <div class="box-body">
                        <form id="tenderForm" action="" method="POST">
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-xl-6">
                                    <label class="form-control-label">Select Tool<span
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="quantity" name="quantity" required min="0"
                                    max="999" oninput="if(this.value.length > 3) this.value = this.value.slice(0, 3);">
                            </div>
                            <!-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="amount" name="amount" readonly>
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Posted Product Requests</h3>
                            </div>
                            <div class="box-body">
                    ...
                    ORDER BY deadline DESC";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<thead><tr><th>Title</th><th>Description</th><th>Quantity</th><th>Unit Price</th><th>Amount</th><th>Deadline</th><th>Posted At</th><th>Status</th><th>Actions</th></tr></thead>";
                                    echo "<tbody>";
