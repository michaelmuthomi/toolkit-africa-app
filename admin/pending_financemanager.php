    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update financemanager set status=1 where idnumber = '$idnumber '")) {
                ...
                echo "<script>location.href='pending_financemanager.php' </script>";
            } else {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Finance Manager Pending Accounts</h2>
                    <br>
                        <!-- Dropdown Selection -->
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                        <a class="dropdown-item" href="approved_financemanager.php">Approved</a>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <tbody>
                                                <?php
                                                    $query_run = mysqli_query($con, "SELECT * FROM financemanager where status=0");
                                                    $i = 1;
