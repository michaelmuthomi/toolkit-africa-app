...
error_reporting(0);
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        if (mysqli_query($con, "update driver set status=1 where idnumber = '$idnumber '")) {
            echo "<script>alert('Approved')</script>";
            echo "<script>location.href='pending_driver.php' </script>";
        } else {
    ...
    if (isset($_POST['disableBtn'])) {
        ...
        if (mysqli_query($con, "update driver set status=2 where idnumber = '$idnumber '")) {
                        ...
                        <div class="col-md-12">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                    <a class="dropdown-item" href="approved_driver.php">Approved</a>
                                    <a class="dropdown-item" href="declined_driver.php">Disabled</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <th>Phone</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $query_run = mysqli_query($con, "SELECT * FROM driver where status=0");
                                                $i = 1;
