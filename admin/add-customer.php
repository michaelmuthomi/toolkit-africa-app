...
if(isset($_POST['submit'])) {
    ...
    if ($dbh) {
        $sql = "INSERT INTO customer (idnumber, fname, lname, gender, email, password, phone, address, status, created_on, DateofBirth, Answer) VALUES (:idnumber, :firstname, :lastname, :Gender, :email, :password, :phone, :address, :status, now(), :dob, :answer)";
        ...
        if($lastInsertId) {
            ...
            $msg = "Customer Registration Was Successfully";
        }
    } else {
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title text-center"><font color="maroon"><b>Customer Account Registration</b></font></h3>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="Customer/admin/index.php"><i class="fa fa-home"></i> Back</a></li>
