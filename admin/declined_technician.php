...
error_reporting(0);
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        if (mysqli_query($con, "update technician set status=1 where idnumber = '$idnumber '")) {
            ...
            echo "<script>location.href='declined_technician.php' </script>";
        } else {
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column ">
            ...
            <div id="content">
                ...
                <h2> Technician Disabled Accounts</h2>
                 <br>
                        ...
                        <div class="col-md-12">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                     ...
                                     <a class="dropdown-item" href="pending_technician.php">Pending</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <th>Password</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $query_run = mysqli_query($con, "SELECT * FROM technician where status=2");
                                                $i = 1;
