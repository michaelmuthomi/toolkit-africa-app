    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update supplier set status=1 where idnumber = '$idnumber '")) {
                ...
                echo "<script>location.href='pending_supplier.php' </script>";
            } else {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Supplier Pending Accounts</h2>
                    <br>
                        <!-- Dropdown Selection -->
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                        ...
                                        <a class="dropdown-item" href="declined_supplier.php">Disabled</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <thead>
                                            ...
                                            <th>Phone</th>
                                                ...
                                                <tbody>
                                                <?php
                                                    $query_run = mysqli_query($con, "SELECT * FROM supplier where status=0");
                                                    $i = 1;
