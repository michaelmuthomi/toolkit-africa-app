            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <br>
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Shipment Details</h1>
                        <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            // SQL query to fetch shipment details
                            $query = "SELECT 
                                        idnumber, 
                            ...
                            if ($query_run->num_rows > 0) {
                                while ($row = $query_run->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            // Conditional formatting for shipment status
                                            switch ($row['dispatch_status']) {
                                                case 1:
                                                    echo '<span style="color: green;">Delivered</span>';
                                                    break;
                                                case 2:
                                                    echo '<span style="color: red;">On Transit</span>';
                                                    break;
                                                default:
