...
if (isset($_POST['approveBtn'])) {
    ...
    foreach ($tables as $table) {
        $query = "UPDATE $table SET status=1 WHERE idnumber = '$idnumber'";
        if (!mysqli_query($con, $query)) {
            die("Connection failed on table $table: " . $con->error);
        }
    }

    echo "<script>alert('Approved in all tables');</script>";
...
if (isset($_POST['disableBtn'])) {
    ...
    foreach ($tables as $table) {
        $query = "UPDATE $table SET status=2 WHERE idnumber = '$idnumber'";
        if (!mysqli_query($con, $query)) {
            die("Connection failed on table $table: " . $con->error);
        }
    }

    echo "<script>alert('Disabled in all tables');</script>";
    echo "<script>location.href='approved_servicemanager.php';</script>";
}
?>
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Employees Disabled Accounts</h2>
                    <br>
                    
                        
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-red-500">Employee Details</h1>
<div class="row">
    <div class="col-md-12">
                                            ...
                                            < <td>
                                                            <div class="dropdown" style="float: left;">
                                                                <button class="btn btn-danger btn-xs" type="button"
                                                                    data-toggle="dropdown">Enable</button>
