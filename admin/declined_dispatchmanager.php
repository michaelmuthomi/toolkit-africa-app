    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update 	dispatcher set status=1 where idnumber = '$idnumber '")) {
                ...
                echo "<script>location.href='declined_dispatchmanager.php' </script>";
            } else {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Dispatch Manager Disabled Accounts</h2>
                    <br>
                    <!-- Dropdown Selection -->
                    <div class="row mb-3">
                            <div class="col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            ...
                                            <th>Password</th>
                                                ...
                                                <tbody>
                                                <?php
                                                    $query_run = mysqli_query($con, "SELECT * FROM 	dispatcher where status=2");
                                                    $i = 1;
