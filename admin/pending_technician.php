    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update technician set status=1 where idnumber = '$idnumber '")) {
                echo "<script>alert('Approved')</script>";
                echo "<script>location.href='pending_technician.php' </script>";
            } else {
        ...
        if (isset($_POST['disableBtn'])) {
            ...
            if (mysqli_query($con, "update technician set status=2 where idnumber = '$idnumber '")) {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Technician Pending Accounts</h2>
                    <br>
                        <!-- Dropdown Selection -->
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                        <a class="dropdown-item" href="approved_technician.php">Approved</a>
                                        <a class="dropdown-item" href="declined_technician.php">Disabled</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <thead>
                                            ...
                                            <th>Phone</th>
                                                ...
                                                <tbody>
                                                <?php
                                                    $query_run = mysqli_query($con, "SELECT * FROM technician where status=0");
                                                    $i = 1;
