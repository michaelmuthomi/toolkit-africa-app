    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update financemanager set status=1 where idnumber = '$idnumber '")) {
                ...
                echo "<script>location.href='pending_fumigator.php' </script>";
            } else {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2>Fumigator Pending Accounts</h2>
                    <br>
                        <!-- Dropdown Selection -->
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                        <a class="dropdown-item" href="approved_fumigator.php">Approved</a>
                                        <a class="dropdown-item" href="declined_fumigator.php">Disabled</a>
                                    </div>
                                </div>
                            </div>
                        </div>
