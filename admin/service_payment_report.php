    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column ">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Service Payment Reports</h1>
                <!-- Search Filter -->
                <div class="row mb-3">
                    <div class="col-md-6">
                        <input type="text" id="paymentSearch" class="form-control" placeholder="Type to search payments...">
                    </div>
                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if ($result && mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>" . htmlspecialchars($row['charges']) . "</td>";
                                            echo "<td>" . htmlspecialchars($row['transactioncode']) . "</td>";
