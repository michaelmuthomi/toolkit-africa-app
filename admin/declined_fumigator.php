...
error_reporting(0);
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        if (mysqli_query($con, "update fumigator set status=1 where idnumber = '$idnumber '")) {
            echo "<script>alert('Approved')</script>";
            echo "<script>location.href='declined_fumigator.php' </script>";
        } else {
    ...
    if (isset($_POST['disableBtn'])) {
        ...
        if (mysqli_query($con, "update fumigator set status=2 where idnumber = '$idnumber '")) {
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column ">
            ...
            <div id="content">
                ...
                <h2> Fumigator Disabled Accounts</h2>
                 <br>
                        ...
                        <div class="col-md-12">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="statusDropdown">
                                     ...
                                     <a class="dropdown-item" href="pending_fumigator.php">Pending</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <th>Password</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $query_run = mysqli_query($con, "SELECT * FROM fumigator where status=2");
                                                $i = 1;
