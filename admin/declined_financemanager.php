    ...
    error_reporting(0);
        ...
        if (isset($_POST['approveBtn'])) {
            ...
            if (mysqli_query($con, "update financemanager set status=1 where idnumber = '$idnumber '")) {
                ...
                echo "<script>location.href='declined_financemanager.php' </script>";
            } else {
        ...
        <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column ">
                ...
                <div id="content">
                    ...
                    <h2> Finance Manager Disabled Accounts</h2>
                    <br>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <thead>
                                            ...
                                            <th>Password</th>
                                                ...
                                                <tbody>
                                                <?php
                                                    $query_run = mysqli_query($con, "SELECT * FROM financemanager where status=2");
                                                    $i = 1;
