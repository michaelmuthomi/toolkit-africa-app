            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <?php
                            // SQL query to join `orders` and `order_items`
                            $query = "
                                SELECT 
                                    o.idnumber, 
                                    CONCAT(o.fname, ' ', o.lname) AS name, 
                                    o.email, 
                                    oi.product_name AS product_names, 
                                    oi.price AS prices, 
                                    oi.quantity AS quantities, 
                                    o.totalamount, 
                                    o.payment_status, 
                                    o.date_paid 
                                FROM orders o
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($row['payment_status'] == 1) {
                                                echo '<span style="color: green;">Paid and Approved</span>';
                                            } elseif ($row['payment_status'] == 0) {
                                                echo '<span style="color: orange;">Paid and Not Approved</span>';
                                            } else {
