                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                      <div class="small-box bg-success">
                        <div class="inner">
                          <h3>Lessons</h3>
                          <p>Manage Course Lessons</p>
                        </div>
                        <div class="icon">
                          <i class="fas fa-list"></i>
                        </div>
                        <a href="<?php echo base_url ?>faculty/?page=lesson" class="small-box-footer">
                          More info <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                      <div class="small-box bg-warning">
                        <div class="inner">
                          <h3>Media</h3>
                          <p>File Uploads & Resources</p>
                        </div>
                        <div class="icon">
                          <i class="fas fa-photo-video"></i>
                        </div>
                        <a href="<?php echo base_url ?>faculty/?page=file_uploads" class="small-box-footer">
                          More info <i class="fas fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div>
