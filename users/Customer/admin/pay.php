...
// Check for session messages (errors and success)
                            ...
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 0;
                                        $statement = $pdo->prepare("SELECT * FROM booking where fname=:admin");
                                        $statement->bindParam(':admin', $_SESSION['admin']);
                                        $statement->execute();
