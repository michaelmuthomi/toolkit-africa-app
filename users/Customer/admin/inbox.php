...
$permissions = [
    ...
    'inventory manager' => ['customer', 'inventorymanager', 'service manager', 'supervisor', 'bnote_cleaner', 'dispatch', 'finance', 'driver', 'customer'],
    'supervisor' => ['customer', 'servicemanager', 'bnote_cleaner', 'dispatch'],
    'service manager' => ['servicemanager', 'supervisor', 'bnote_cleaner', 'customer'],
    //'inspector' => ['inventory manager', 'customer'],
    'bnote_cleaner' => ['servicemanager', 'supervisor'],
    'dispatch' => ['inventorymanager', 'driver', 'customer'],
    'finance' => ['customer', 'dispatch'],
    ...
    <section class="content">
      ...
      <div class="container" style="background-color: white; padding: 20px; border-radius: 8px;">
        <div class="row">
          <div class="col-md-4">
            <!-- User List -->
            <h4>Select an employee to start chatting</h4>
            <ul class="list-group">
