...
if ($cadm_password!= $password) {
    ...
    if(mysqli_num_rows(mysqli_query($conn,"SELECT * from finance where email='$email'"))>0){
        if(mysqli_query($conn,"UPDATE finance set password='$password' where email='$email'")){
