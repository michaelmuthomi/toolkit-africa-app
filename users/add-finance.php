...
if(isset($_POST['submit'])) {
    ...
    if ($dbh) {
        $sql = "INSERT INTO finance (idnumber, fname, lname, gender, email, password, phone, address, status, created_on, DateofBirth, Answer) VALUES (:idnumber, :firstname, :lastname, :Gender, :email, :password, :phone, :address, :status, now(), :dob, :answer)";
        ...
        if($lastInsertId) {
            ...
            $msg = "Finance Manager Registration Was Successfully";
        }
    } else {
...
<html lang="en">
    <head>
        ...
        <title>Finance Manager Registration </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title text-center"><font color="maroon"><b>Finance Manager Account Registration</b></font></h3>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="Finance/admin/index.php"><i class="fa fa-home"></i> Back</a></li>
