...
if(isset($_POST['submit'])) {
    ...
    if ($dbh) {
        $sql = "INSERT INTO bnote_cleaner(idnumber, fname, lname, gender, email, password, phone, address, status, created_on, DateofBirth, Answer) VALUES (:idnumber, :firstname, :lastname, :Gender, :email, :password, :phone, :address, :status, now(), :dob, :answer)";
        ...
        if($lastInsertId) {
            ...
            $msg = "Banknote Cleaner Registration Was Successfully";
        }
    } else {
...
<html lang="en">
    <head>
        ...
        <title>Banknote Cleaner Registration </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title text-center"><font color="maroon"><b>Banknote Cleaner Account Registration</b></font></h3>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="Banknote-Cleaner/admin/index.php"><i class="fa fa-home"></i> Back</a></li>
                        ...
                        <input type="tel" name="phone" class="form-control" id="phone" minlength="10" maxlength="10" placeholder="07...." required="required" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                            <label for="default" class="col-sm-2 control-label">Security Phrase</label>
                                            <div class="col-sm-10">
