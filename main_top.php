    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php">   
          <button class="btn btn-user btn-round btn-sm text-white font-medium" type="submit" name="btnlogin">
      ...
      <li class="nav-item">
        <a class="nav-link" href="aboutus.php" role="button" aria-haspopup="true" aria-expanded="false">   
          <button class="btn btn-user btn-round btn-sm text-white font-medium" type="submit" name="btnlogin">
      ...
      <li class="nav-item">
        <a class="nav-link" href="users/login.php" aria-haspopup="true" aria-expanded="false">   
          <button class="btn btn-user btn-round btn-sm text-white font-medium" type="submit" name="btnlogin">
      ...
      <li class="nav-item">
        <a class="nav-link" href="help.php" aria-haspopup="true" aria-expanded="false">   
          <button class="btn btn-user btn-round btn-sm text-white font-medium" type="submit" name="btnlogin">
